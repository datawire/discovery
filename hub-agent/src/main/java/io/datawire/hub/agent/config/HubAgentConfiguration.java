...
public class HubAgentConfiguration {

  private final ListenerConfig listener;
  private final LauncherConfig launcher;

  public HubAgentConfiguration(
      @JsonProperty("listener") ListenerConfig listener,
      @JsonProperty("launcher") LauncherConfig launcher
  ) {
