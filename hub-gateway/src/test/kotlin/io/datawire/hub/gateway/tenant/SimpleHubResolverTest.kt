...
class SimpleHubResolverTest {

  private val fixtures = Fixtures()

  private val resolver = SimpleHubResolver(mapOf(
      "datawire" to setOf("10.0.1.10:52689", "10.0.1.11:52689"),
      "foo-corp" to setOf("10.0.2.10:52689")
  ))

  @Test
  fun resolve_tenantExists_returnSetOfTenantHubs() {
  ...
  fun buildFromValidYaml_returnsExpectedResolver() {
    val yamlDocument = fixtures.loadFixture("valid_SimpleHubResolver.yml")
    val objectMapper = ObjectMapper(YAMLFactory())
    val newResolver = objectMapper.readValue(yamlDocument, HubResolverFactory::class.java).build()
